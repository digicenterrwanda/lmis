...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/quickexplorer/mod1/quickexplorer_zipfile.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/quickexplorer/mod1/quickexplorer_zipfile.php']);
}
