...
function textArea(element,conf) {
	...
	this.lang = new loadLocalLang(this.conf['languageKey'], this.baseURL+'Resources/Private/Language/locallang.xml')
...
function loadLocalLang(langKey,xmlFile) {
	if (langKey) {
		this.local_lang = this.loadXMLDoc(langKey, (xmlFile ? xmlFile : 'Resources/Private/Language/locallang.xml'));
	}
}
